...
```{example} Energia potenziale gravitazionale
...
```{example} Velocità angolare e momento torcente
...
```{example} Lavoro in un piano inclinato
...
```{example} Conservazione dell'energia
